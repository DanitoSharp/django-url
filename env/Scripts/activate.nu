...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Daniel Ekeleme\Desktop\Django\django-url\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Daniel Ekeleme\Desktop\Django\django-url\env\Scripts\deactivate.nu'
